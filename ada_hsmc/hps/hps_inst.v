	hps u0 (
		...
		.data_in_cumsum_external_connection_export       (<connected-to-data_in_cumsum_external_connection_export>),       //       data_in_cumsum_external_connection.export
		.data_in_exptime_external_connection_export      (<connected-to-data_in_exptime_external_connection_export>),      //      data_in_exptime_external_connection.export
		.data_in_readbuffer_external_connection_export   (<connected-to-data_in_readbuffer_external_connection_export>),   //   data_in_readbuffer_external_connection.export
		.data_in_samples_external_connection_export      (<connected-to-data_in_samples_external_connection_export>),      //      data_in_samples_external_connection.export
		.data_in_trigger_external_connection_export      (<connected-to-data_in_trigger_external_connection_export>),      //      data_in_trigger_external_connection.export
		.data_out_readpointer_external_connection_export (<connected-to-data_out_readpointer_external_connection_export>), // data_out_readpointer_external_connection.export
